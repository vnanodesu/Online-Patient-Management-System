...
<div class="form-group">
              ...
              <?php  if($row['Gender']=="Single"){ ?>
             <input type="radio" name="gender" id="gender" value="Married" checked="true">Married
              <input type="radio" name="gender" id="gender" value="Single">Single
              <?php } else { ?>
              <label>
                   <input type="radio" name="gender" id="gender" value="Single" checked="true">Single
